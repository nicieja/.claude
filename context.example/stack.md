...
- **Tracker:** <name + how sessions connect to it: MCP connector / CLI / API>
...
- **Project skills:** <where they live, if anywhere: skills/, .claude/skills/, …>
- **WIP cap:** <max concurrent build lanes for dispatched work; default 3>
