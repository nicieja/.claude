...
3. Present the verdicts — dead / dormant / alive — with two caveats stated plainly: the window is bounded by transcript retention (~30 days by default), and cadence-based skills (call prep, weekly reviews) can legitimately sit quiet longer than the window.
