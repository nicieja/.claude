...
The output is instructions to an executor, not the plan. The plan already exists; your job is to tell someone how to carry it out. If what you produce could be mistaken for the plan itself — a restatement, a summary, a reordering of its steps — you have written the wrong document. Start over.
...
- Do not restate the plan's steps in your own words anywhere in the prompt. The plan is the spec; the prompt is the briefing around it.
